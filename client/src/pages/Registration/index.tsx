  ...
  return (
    <Box
      sx={{
        ...
        margin: "0 auto",
        marginTop: 4,
        marginBottom: 4 , // Add marginTop to create space from the top
        padding: 2,
        paddingBottom: 4, // Add paddingBottom to create space at the bottom
        border: "1px solid #ccc",
        borderRadius: "8px",
      }}
    >
        <div className="flex flex-col items-center gap-3">
            <img src={hospitalLogo} alt="Hospital logo"  className="w-[40%] rounded-3xl"/>
